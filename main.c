...
#pragma config(Motor,  port8,           flippingMotorRight, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           flippingMotorLeft, tmotorVex393_MC29, openLoop)
...
void outsideClawMovement(){
	if(vexRT[Btn6U] == 1){
			...
			motor[flippingMotorLeft] = 100;
			motor[flippingMotorRight] = 100;
