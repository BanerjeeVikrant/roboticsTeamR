...
#pragma config(Motor,  port8,           topRight,      tmotorVex393_MC29, openLoop, reversed)
...
//basicMovement()
int controlSensitivity = 1;

//claw speeds
int openClawSpeed = 127;
int closeClawSpeed = 127;
...
void basicMovement(){
	  ...
	  motor[leftMotor1] = vexRT[Ch2] * controlSensitivity;
	  motor[leftMotor2] = vexRT[Ch2] * controlSensitivity;
	  motor[rightMotor1] = vexRT[Ch3] * controlSensitivity;
	  motor[rightMotor2] = vexRT[Ch3] * controlSensitivity;
...
void armUp(){
	createMovementArmSpeed(armSpeedOpen);
}

void armDown(){
	createMovementArmSpeed(armSpeedClose);
}

void armStop(){
	createMovementArmSpeed(armSpeedStop);
}
