...
#pragma config(Motor,  port8,           flippingMotorLeft, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           flippingMotorRight, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port10,          topRightMotor1, tmotorVex393_HBridge, openLoop)
